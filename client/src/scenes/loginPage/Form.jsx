            ...
            {isRegister && (
              <>
                ...
                <TextField
                  ...
                  name="hardskills"
                  error={
                    Boolean(touched.hardskills) && Boolean(errors.hardskills)
                  }
                  helperText={touched.hardskills && errors.hardskills}
                  sx={{ gridColumn: "span 4" }}
                />
                <TextField
                  label="Soft Skills"
                  ...
                  name="softskills"
                  error={
                    Boolean(touched.softskills) && Boolean(errors.softskills)
                  }
                ...
                <TextField
                  ...
                  name="workexperience"
                  error={
                    Boolean(touched.workexperience) && Boolean(errors.workexperience)
                  }
                ...
                <TextField
                  ...
                  name="hobbies"
                  error={
                    Boolean(touched.hobbies) && Boolean(errors.hobbies)
                  }
